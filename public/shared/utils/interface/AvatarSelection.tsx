...
export const ImageCropper: React.FC<{
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-xs chat-background">
      <div className="bg-white/5 backdrop-blur-lg rounded-lg p-6 w-[90%] max-w-2xl border border-white/20 shadow-xl animate-input-push">
        <div className="flex flex-col items-center mb-4">
          ...
          <div className="mb-4">
            <p className="text-neutral-50/70 text-sm text-center">
        ...
        <div className="flex justify-center gap-3">
          <button
            type="button"
            className="px-6 py-2 rounded-lg bg-lime-700 hover:bg-lime-800 text-neutral-50 use-crop-btn cursor-pointer"
          ...
          <button
            type="button"
            className="px-6 py-2 rounded-lg bg-white/5 border border-white/20 hover:bg-red-700 text-neutral-50 cancel-btn cursor-pointer"
            onClick={onCancel}
          >
            Cancel
          </button>
  ...
  return (
    <>
      ...
      {!showCropper && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-xs chat-background">
          <div
            className="relative bg-white/5 backdrop-blur-lg rounded-lg p-6 w-[90%] max-w-md border border-white/20 shadow-xl chat-background animate-input-push"
            onClick={(e) => e.stopPropagation()}
          >
            <h2 className="text-xl text-center font-bold mb-8 text-neutral-50">
              Update Your Avatar
            </h2>
            ...
            <form onSubmit={handleSubmit}>
              <div className="flex flex-col items-center mb-4">
                ...
                {previewUrl && !showCropper ? (
                  <button
                    type="button"
                    className="text-sm text-neutral-50/70 hover:text-neutral-50 underline"
                    onClick={handleUploadClick}
                  >
